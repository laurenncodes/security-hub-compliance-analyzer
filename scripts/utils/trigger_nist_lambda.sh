#!/bin/bash
# Script to invoke the SecurityHub Compliance Analyzer Lambda for NIST 800-53 reports

# Default function name (can be overridden with environment variable)
FUNCTION_NAME=${LAMBDA_FUNCTION_NAME:-"security-hub-compliance-analyzer-SecurityHubAnalyzer"}
...
# Create payload with the provided email
...
echo "Response saved to lambda_response.json"
